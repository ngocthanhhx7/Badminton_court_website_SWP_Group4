...
<%@ page import="java.util.*, models.BlogPostDTO, dal.BlogPostDAO" %>
<%@ page import="dal.BlogCommentDAO, models.BlogCommentDTO" %>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="feed">
                                        <% if (posts == null || posts.isEmpty()) { %>
                                            <div class="alert alert-info" style="text-align:center; color: #0c5460; background-color: #d1ecf1; border: 1px solid #bee5eb; padding: 15px; border-radius: 5px; margin: 20px 0;">
                                                <% if (posts == null) { %>
                                                    <strong>⚠️ Lỗi kết nối cơ sở dữ liệu</strong><br>
                                                    Không thể tải danh sách bài viết. Vui lòng thử lại sau hoặc liên hệ quản trị viên.
                                                <% } else { %>
                                        ...
                                        <% } else if (posts != null) {
                                            for (BlogPostDTO post : posts) {
                                                ...
                                                try {
                                                    comments = commentDAO.getByPostId(post.getPostID());
                                                } catch (Exception e) {
