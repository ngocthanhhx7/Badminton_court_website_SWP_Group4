...
function formatInputDate() {
    const inputDate = document.getElementById('dateInput').value; // Get the value from the input field
    const formattedDate = formatDate(inputDate);
    document.getElementById('formattedDate').innerText = formattedDate; // Display formatted date
}
