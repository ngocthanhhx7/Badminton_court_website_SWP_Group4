...
public class CourtRateDAO {
    ...
    public double getRandomPriceByCourtID(int courtID) {
        double price = 0.0;

        String sql = "SELECT HourlyRate FROM CourtRates WHERE CourtID = ?";
        try (Connection conn = DBUtils.getConnection();
            ...
            price = rs.getDouble("HourlyRate");

        } catch (Exception e) {
            System.err.println("Error getting random price: " + e.getMessage());
            e.printStackTrace();
        }
